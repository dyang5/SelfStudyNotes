...
($S$ is a sort of inversion about the unit circle: it brings points outside in and points inside out.) \\
...
\begin{itemize}
    ...
    \item Continue above two steps until neither of them reduces $\alpha$.
\end{itemize}
