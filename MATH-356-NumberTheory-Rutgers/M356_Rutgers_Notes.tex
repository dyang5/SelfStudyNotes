...
\begin{proof}
Let $\mathcal{I}_1 \subseteq \mathcal{I}_2 \subseteq  \dots$ be an increasing chain of ideals. Let
\[
...
Since for any $n > N$, $\mathcal{I}_n \subseteq \mathcal{I}_N$, it follows that $R$ is Noetherian. 
\end{proof}

\begin{theorem}
Noehterian rings are a UFD.
\end{theorem}

\begin{remark}
Note that Euclidean Domains imply PID which imply Noetherian ring which imply UFD. \\
